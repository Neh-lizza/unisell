    ...
    return (
      <div style={{ background: '#FAF7F2', minHeight: '100vh' }}>
        <div className="max-w-[760px] mx-auto px-6 py-8">
          ...
          <div className="w-full rounded-2xl bg-[#E2D9C5] animate-pulse mb-6" style={{ height: 360 }} />
      ...
      <div style={{ background: '#FAF7F2', minHeight: '100vh' }}>
        <div className="max-w-[760px] mx-auto px-6 py-16 text-center">
          <div className="w-16 h-16 bg-[#FBE6E1] rounded-2xl flex items-center justify-center mx-auto mb-4">
            <svg width={28} height={28} viewBox="0 0 24 24" fill="none" stroke="#B83A2C" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <div className="max-w-[760px] mx-auto px-6 py-8">
        ...
        {listing.image_url ? (
          <img src={listing.image_url} alt={listing.title}
            className="w-full rounded-2xl mb-6 object-cover" style={{ maxHeight: 420 }} />
        ) : (
          <div className="w-full rounded-2xl mb-6 bg-[#E2D9C5] flex items-center justify-center text-sm font-semibold uppercase tracking-widest text-[#888]"
            style={{ height: 280 }}>
            No photo
          </div>
        )}
        ...
        {similar.length > 0 && (
          <div>
            <h2 className="m-0 mb-4 text-lg font-bold text-[#1B4332]">Similar items you might like</h2>
                ...
                return (
                  <Link key={s.id} href={`/listings/${s.id}`}
                    ...
                    <div className="p-3">
                      ...
                      <p className="m-0 text-base font-bold text-[#D97706] mt-0.5">{s.price.toLocaleString()} XAF</p>
                    </div>
                  </Link>
                )
              })}
