  ...
  return (
    ...
    >
      <span
        ...
        className="w-1 h-1 md:w-1.5 md:h-1.5 rounded-full inline-block flex-shrink-0"
      />
      {value}
    </span>
  )
      ...
      <section className="bg-[#FAF7F2] border-b border-[#EFE9DD]">
        <div className="max-w-[1180px] mx-auto px-4 md:px-6 pt-10 md:pt-16 pb-6 md:pb-8">
          ...
          <p className="text-sm md:text-lg leading-relaxed text-[#3D3D3D] max-w-[640px] mb-6 md:mb-8">
            University students buy and sell secondhand items safely. Browse free. Contact sellers
          ...
          <div
            className="mt-3 md:mt-4 flex gap-1.5 md:gap-2 overflow-x-auto pb-1"
        ...
        <div className="max-w-[1180px] mx-auto px-4 md:px-6">
          ...
          {!loading && listings.length === 0 && (
            <div className="bg-white border border-[#EFE9DD] rounded-2xl p-10 md:p-16 text-center">
              ...
              {query ? (
                <>
                  <p className="m-0 mb-2 text-base md:text-lg font-bold text-[#1B4332]">
                    No listings found for "{query}"
                  </p>
                  <p className="m-0 mb-5 text-sm text-[#6B6B6B]">
