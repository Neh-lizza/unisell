  ...
  return (
    <header className="bg-[#1B4332] text-[#FAF7F2] sticky top-0 z-30 border-b border-white/[0.06]">
      <div className="h-14 max-w-[1280px] mx-auto px-6 flex items-center justify-between relative">
        ...
        <Link
          href="/sell"
          className="hidden md:inline-flex items-center gap-1.5 bg-[#D97706] text-[#FAF7F2] no-underline text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#B45309] transition-colors"
        >
          Sell item
      ...
      {/* Mobile drawer */}
      <div className={`md:hidden bg-[#143027] overflow-hidden transition-all duration-200 ${open ? 'max-h-72' : 'max-h-0'}`}>
